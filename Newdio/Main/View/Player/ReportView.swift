...
class ReportView: UIView {
    ...
    private var translateErrorButton: UIButton = {
        ...
        btn.addTarget(self, action: #selector(didTapTranslateBtn), for: .touchUpInside)
    ...
    private var summaryErrorButton: UIButton = {
        ...
        btn.addTarget(self, action: #selector(didTapSummaryBtn), for: .touchUpInside)
        btn.setImage(UIImage(systemName:"circle"), for: .normal)
        btn.tintColor = .newdioGray2
        return btn
    }()
    ...
    private var soundErrorButton: UIButton = {
        ...
        btn.addTarget(self, action: #selector(didTapSoundBtn), for: .touchUpInside)
        btn.setImage(UIImage(systemName:"circle"), for: .normal)
        btn.tintColor = .newdioGray2
        return btn
    }()
    ...
    private var etcErrorButton: UIButton = {
        ...
        btn.addTarget(self, action: #selector(didTapEtcBtn), for: .touchUpInside)
